...
<input class="pp_showWheel1" id="pp_showWheel1" type="hidden" value="<?php echo esc_attr(get_option( 'pp_showWheel1' )); ?>" />
<input class="pp_showWheel2" id="pp_showWheel2" type="hidden" value="<?php echo esc_attr(get_option( 'pp_showWheel2' )); ?>" />
<input class="pp_showMoon" id="pp_showMoon" type="hidden" value="<?php echo esc_attr(get_option( 'pp_showMoon' )); ?>" />
<input class="pp_local" id="pp_local" type="hidden" value="<?php echo esc_attr(get_option( 'pp_local' )); ?>" />
